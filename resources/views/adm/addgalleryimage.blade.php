    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="update_image" method="POST" action="{{ route('addGalleryImage') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select id="position" name="position" class="form-control">
                                @for ($i = 1; $i <= $count + 1; $i++)
                                    <option value="{{ $i }}" @if ($i == $count + 1) selected @endif >{{ $i }}</option>
                                @endfor
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3" style="width: 600px; overflow: hidden;">
                                <img id="imgfile" src="" alt="" style="width: 600px;">
                            </div>
