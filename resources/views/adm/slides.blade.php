                            ...
                            <tr>
                                <td class="align-middle">
                                    @if($slide->position > 1 && $slide->position < count($slides))
                                        <a class="" href="javascript:movePosition('{{$slide->id}}', '{{$slide->position - 1}}', '{{ csrf_token() }}', 'slides')">
                                    ...
                                    @elseif($slide->position == 1 && count($slides) > 1)
                                        ...
                                        <a href="javascript:movePosition('{{$slide->id}}', '{{$slide->position + 1}}', '{{ csrf_token() }}', 'slides')">
                                            <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-arrow-square" fill="currentColor">
                                                <path fill-rule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                                <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4z"/>
                                            </svg>
                                ...
                                <td class="text-center align-middle">
                                    <a class="btn btn-primary" href="{{ route('getSlide', [$slide->id]) }}">Edit</a>
