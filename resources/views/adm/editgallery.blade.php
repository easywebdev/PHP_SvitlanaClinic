...
<div class="container">
    <div class="row justify-content-center">
        <div class="card gallery-content-min-w">
                            ...
                            <tr>
                                <td class="align-middle">
                                    @if($image->position > 1 && $image->position < count($images))
                                        <a class="nav-pos" href="javascript:movePosition('{{$image->id}}', '{{$image->position - 1}}', '{{ csrf_token() }}', 'galleries', '{{ $service['id'] }}')">
                                ...
                                <td class="text-center align-middle">
                                    <a class="btn btn-primary slide-btn-adaptive" href="{{ route('getGalleryImage', [$image->id]) }}">Edit</a>
