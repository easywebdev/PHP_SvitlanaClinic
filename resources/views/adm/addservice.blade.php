    ...
    <div class="row justify-content-center">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="update_service" method="POST" action="{{ route('addService') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="position" name="position" class="form-control">
                                    ...
                                    @endfor
                                        <option value="{{ $count + 1 }}" selected>At last</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="keywords" type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" value="">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="text" class="form-control @error('text') is-invalid @enderror" name="text"></textarea>
